...
export type { BorrowedBooksResponse } from './models/borrowed-books-response';
...
export type { PageResponseBorrowedBooksResponse } from './models/page-response-borrowed-books-response';
